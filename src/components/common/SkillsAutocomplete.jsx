...
const SkillsAutocomplete = ({ input: { value, onChange } }) => {
  ...
  const onAddition = tag => {
    ...
    if(Array.isArray(value)) {
      if(value.some(val => val.id === tag.id)) {
        return;
      }
      newValue = [...value, tag];
    }
